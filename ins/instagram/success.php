...
function fetchData($url){
  ...
  mysql_query('insert into tbl_social_url(user_id,social_type,sub_type,link,created_time,caption) value("'.$_SESSION['email'].'","instagram","post_images","'.$post->images->standard_resolution->url.'","'.$post->created_time.'","'.$post->caption->text.'")');
  }
