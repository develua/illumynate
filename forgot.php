...
{
    $email=$_POST['email'];
    $select_email=mysql_query('select * from users where email="'.$email.'"');
    $fetch_row=mysql_fetch_array($select_email);
					...
					<div class="col-md-6 col-md-offset-3">
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form action="" class="mt" id="forgot" method="post">

									<label for="email" class="text-uppercase text-sm">Your Email</label>
									<input type="email" id="email" name="email" placeholder="Username" class="form-control mb">

									<button id="submit" name="forgot" class="btn btn-primary btn-block" type="submit">Submit</button>
