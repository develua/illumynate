...
<script type="text/javascript" src="../js/lib/jquery-1.10.1.min.js"></script>
    ...
    <div class="content-wrapper" style="margin-top: 15px;">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-xs-12" style="margin-bottom: 10px;">
                   <strong style="padding: 10px;"><a href="sample.php">Please Login Again For New Data</a></strong>
    ...
    color: white;
    padding: 15px; text-align: center; padding-top:6px;"><?php if($fetch_exist_images['resolved_tag']!=null && $fetch_exist_images['resolved_tag']!=""){echo $fetch_exist_images['resolved_tag'];} else { echo "No Tag"; } ?>
                        </div>
                        <hr />
                       <a class="fancybox-buttons thumbnail" data-fancybox-group="button" href="<?php echo $fetch_exist_images['resolved_url']; ?>">
                            <div class="img-responsive imagesss" alt="" width="100%" style="min-height: 209px; max-height: 209px; padding: 10px; color: #3e454c"> <?php echo $fetch_exist_images['link']; ?>
                            </div> 
                        </a>


                       <!-- <a class="fancybox-buttons thumbnail" data-fancybox-group="button" href="<?php echo $fetch_exist_images['resolved_url']; ?>">
                            <img class="img-responsive imagesss" src="<?php echo $fetch_exist_images['link']; ?>" alt="" width="100%" style="min-height: 209px; max-height: 209px;">
                        </a> -->
                    </div>
