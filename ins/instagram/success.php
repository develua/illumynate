...
function fetchData($url){
  ...
  mysql_query('insert into tbl_social_url(user_id,social_type,sub_type,link,created_time,caption,users_in_photo) value("'.$_SESSION['email'].'","instagram","post_images","'.$post->images->standard_resolution->url.'","'.$post->data->created_time.'","'.$post->caption->text.'","'.$post->type.'")');
  }
