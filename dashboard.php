			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title" style="background: aliceblue;padding: 15px;">All</h3>
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-3">
										...
										<div class="panel panel-default">
											...
											<a href="All.php" class="block-anchor panel-footer">All<i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
                                </div>
							</div>
						...
						<hr style="width: 100%;"/>
                        <h3 class="page-title" style="background: aliceblue;padding: 15px;">MY Content</h3>
					    <div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-3">
										...
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light" style="background: url('data:image/png;base64,'); background-size: cover">
												<div class="stat-panel text-center">
													<div class="stat-panel-number h1 "><?php echo $fetch_total_num_fb['counts'];?></div>
													<div class="stat-panel-title text-uppercase">Total Pictures</div>
												</div>
											</div>
											<a href="facebook/success.php" class="block-anchor panel-footer">Facebook<i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
